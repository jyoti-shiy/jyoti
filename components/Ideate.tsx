...
const Ideate = () => {
  return (
    <div className="mt-11">
      <h1 className="text-center text-3xl uppercase mb-7"> 3. ideate phase </h1>
      ...
      <div className=" bg-[#4f4b4b] p-7 panaBG mt-7  backdrop-filter backdrop-blur-md bg-opacity-20   shadow-md rounded-2xl">
        ...
        <p className="font-thin text-end">
          For a job portal tailored to IT job seekers and recruiters, a card
          sorting exercise can help organize content intuitively for users.
        </p>
        <div className="flex items-center justify-center mt-5">
          <div className="grid gap-8 w-full max-w-4xl md:grid-cols-2 lg:grid-cols-3 text-white">
            ...
            <div className="bg-[#1a1a1a]  backdrop-filter backdrop-blur-md bg-opacity-20   shadow-md  p-6 rounded-lg shadow-zinc-700 hover:shadow-lg transform transition duration-150 ease-in-out">
              <h2 className="text-center font-semibold text-md mb-4">
                Job Seeker&apos;s Dashboard Card Sorting
              </h2>
              <button className="w-full py-2 bg-zinc-700 shadow shadow-zinc-800  backdrop-filter backdrop-blur-md bg-opacity-50 rounded-md mb-3  hover:scale-110 duration-150 ease-in-out">
                Available Job
              </button>
              <button className="w-full py-2 bg-zinc-700 shadow shadow-zinc-800  backdrop-filter backdrop-blur-md bg-opacity-50 rounded-md mb-3  hover:scale-110 duration-150 ease-in-out">
                Applied Job
