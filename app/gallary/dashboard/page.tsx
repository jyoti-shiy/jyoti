    ...
    <div className="pt-24 pb-11 bg-transparent blurAnimation overflow-hidden px-3">
      ...
      <div className="w-full bg-[#232121] rounded-[15px] p-11 gap-3 border border-zinc-600">
        <ul className=" relative">
          ...
          <li className="mb-5 text-[#C8C8C8] font-light list-disc">
            Includes key metrics like visitors, orders, product views, and
            conversion rate.
          </li>
          <li className="mb-5 text-[#C8C8C8] font-light list-disc">
            Side navigation for easy access to products, orders, customers, and
            sales data.
          </li>
          <li className="mb-5 text-[#C8C8C8] font-light list-disc">
            To-do list and balance overview integrated for efficient workflow
            management.
          </li>
        </ul>
      </div>
            ...
            <div className="p-5 flex justify-between items-end">
              <div>
                ...
                <p className="text-zinc-600 text-md text-[13px] leading-snug">
                  Experience the joy of creating and appreciating handcrafted
                  decorative objects, where every piece tells a unique story
          ...
          >
            ...
            <div className="p-5 flex justify-between items-end">
              <div>
                ...
                <p className="text-zinc-600 text-md text-[13px] leading-snug">
                  Welcome to Food Zone, where culinary artistry meets
                  convenience—explore and order exquisite dishes crafted to
                  satisfy your cravings, from breakfast to dinner.
                </p>
              </div>
            </div>
          </div>
